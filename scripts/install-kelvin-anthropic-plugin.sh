...
usage() {
  cat <<'USAGE'
Usage: scripts/install-kelvin-anthropic-plugin.sh [options]

Install Kelvin's first-party Anthropic WASM model plugin from the plugin index.
...
cat <<'EOF2'
ANTHROPIC_API_KEY is required at runtime:
