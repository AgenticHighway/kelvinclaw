...
pub const ENV_DISCORD_GATEWAY_INTENTS: &str = "KELVIN_DISCORD_GATEWAY_INTENTS";
// GUILDS(1) | GUILD_MESSAGES(512) | DIRECT_MESSAGES(4096)
// MESSAGE_CONTENT(32768) is a privileged intent — set KELVIN_DISCORD_GATEWAY_INTENTS=37377
// and enable it in the Discord Developer Portal if you need server channel message content.
pub const DEFAULT_DISCORD_GATEWAY_INTENTS: u64 = 4609;
...
pub const VERIFICATION_METHOD_DISCORD_GATEWAY: &str = "discord_gateway";
